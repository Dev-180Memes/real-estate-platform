...
const Home = () => {
  return (
    <Box as="main" bg="gray.50" minH="100vh">
      ...
      <Box
        position="relative"
        bgImage="url('/house.jpg')" // Replace with your background image URL
        bgPos="center"
        bgSize="cover"
        bgRepeat="no-repeat"
        minH="70vh"
        ...
        _after={{
          ...
          width: '100%',
          height: '100%',
          bg: 'blackAlpha.700', // Black overlay with 70% opacity
          zIndex: 1,
        }}
      >
        <Container maxW="container.lg" zIndex={2} position="relative">
